package com.github.eisermann.opencodelauncher.http

import com.github.eisermann.opencodelauncher.files.FileOpenService
import com.github.eisermann.opencodelauncher.notifications.NotificationService
...
class HttpTriggerService : Disposable {
    ...
    private fun enqueueProjectProcessing(
        project: Project,
        settings: OpenCodeLauncherSettings,
