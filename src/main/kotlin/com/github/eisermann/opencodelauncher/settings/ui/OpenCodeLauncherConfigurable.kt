package com.github.eisermann.opencodelauncher.settings.ui
...
class OpenCodeLauncherConfigurable : SearchableConfigurable {
    ...
    private val settings by lazy { service<OpenCodeLauncherSettings>() }
    ...
    override fun getId(): String = "com.github.eisermann.opencodelauncher.settings"

    override fun getDisplayName(): String = "OpenCode Launcher"
    ...
    override fun createComponent(): JComponent {
        ...
        customModelField.emptyText.text = "e.g. gpt-5.1-codex"
        ...
        enableNotificationCheckbox = JBCheckBox("Enable notifications when events are completed by OpenCode CLI")
        ...
        root = panel {
            ...
            group("Options") {
                ...
                row {
                    this.largeComment("For more information, run opencode --help")
                }
            }
            group("File Handling") {
                row {
                ...
                row {
                    this.largeComment("Changes will take effect after restarting OpenCode.")
                }
            }
            group("Notifications") {
                row {
                ...
                row {
                    this.largeComment(
                        "Customize notification sounds and display options in <a href='notifications'>Settings &gt; Appearance &amp; Behavior &gt; Notifications &gt; OpenCodeLauncher</a>.",
