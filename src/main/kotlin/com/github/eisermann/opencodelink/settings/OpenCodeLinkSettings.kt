package com.github.eisermann.opencodelink.settings

import com.github.eisermann.opencodelink.cli.OpenCodeArgsBuilder
import com.github.eisermann.opencodelink.settings.options.Model
import com.github.eisermann.opencodelink.settings.options.ModelReasoningEffort
import com.github.eisermann.opencodelink.settings.options.Mode
...
/**
 * Application-level settings service for OpenCode Link plugin.
 *
 ...
 *
 * Settings are automatically persisted to OpenCodeLink.xml in the IDE's configuration directory.
 *
 * @since 1.0.0
 */

@Service(Service.Level.APP)
@State(name = "OpenCodeLinkSettings", storages = [Storage("OpenCodeLink.xml")])
class OpenCodeLinkSettings : PersistentStateComponent<OpenCodeLinkSettings.State> {
    /**
