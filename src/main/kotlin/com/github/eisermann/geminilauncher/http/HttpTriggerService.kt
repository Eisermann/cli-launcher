package com.github.eisermann.geminilauncher.http

import com.github.eisermann.geminilauncher.files.FileOpenService
import com.github.eisermann.geminilauncher.notifications.NotificationService
...
class HttpTriggerService : Disposable {
    ...
    private fun enqueueProjectProcessing(
        project: Project,
        settings: GeminiLauncherSettings,
