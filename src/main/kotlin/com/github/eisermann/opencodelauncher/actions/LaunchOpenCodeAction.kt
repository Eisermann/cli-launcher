package com.github.eisermann.opencodelauncher.actions
...
import com.github.eisermann.opencodelauncher.terminal.OpenCodeTerminalManager
...
class LaunchOpenCodeAction : AnAction(DEFAULT_TEXT, DEFAULT_DESCRIPTION, null), DumbAware {
    ...
    companion object {
        ...
        private const val NOTIFICATION_TITLE = "OpenCode Launcher"
    ...
    private fun launchOpenCode(project: Project, terminalManager: OpenCodeTerminalManager) {
        ...
        try {
            ...
            val settings = service<OpenCodeLauncherSettings>()
    ...
    private fun notify(project: Project, content: String, type: NotificationType) {
        runCatching {
            val group = NotificationGroupManager.getInstance().getNotificationGroup("OpenCodeLauncher")
