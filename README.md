...
<img width="800" alt="The screenshot of OpenCode Launcher." src="https://github.com/user-attachments/assets/4ee3fbd8-e384-4672-94c6-e4e9041a8e0d" />

OpenCode Launcher is an **unofficial** IntelliJ IDEA plugin that keeps the OpenCode CLI one click away inside the IDE.
...
- **Completion notifications** after OpenCode finishes processing the current run
...
### Configuration
Open **Settings (→ Other Settings) → OpenCode Launcher** to pick the launch mode, model, notification behavior, and auto-open options.
