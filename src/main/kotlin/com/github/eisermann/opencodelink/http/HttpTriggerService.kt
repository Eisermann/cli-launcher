package com.github.eisermann.opencodelink.http

import com.github.eisermann.opencodelink.files.FileOpenService
import com.github.eisermann.opencodelink.notifications.NotificationService
                ...
                if (requestBody.isNotEmpty()) {
                    ...
                    if (type == "agent-turn-complete") {
                        val notificationMessage = json["last-assistant-message"]?.jsonPrimitive?.content
                            ?: "OpenCode CLI processing completed."
