package com.github.eisermann.opencodelink.settings.ui
...
class OpenCodeLinkConfigurable : SearchableConfigurable {
    ...
    private val settings by lazy { service<OpenCodeLinkSettings>() }
    ...
    override fun getId(): String = "com.github.eisermann.opencodelink.settings"

    override fun getDisplayName(): String = "OpenCode Link"
    ...
    override fun createComponent(): JComponent {
        ...
        root = panel {
            ...
            group("Notifications") {
                ...
                row {
                    this.largeComment(
                        "Customize notification sounds and display options in <a href='notifications'>Settings &gt; Appearance &amp; Behavior &gt; Notifications &gt; OpenCodeLink</a>.",
